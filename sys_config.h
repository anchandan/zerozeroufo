...
#define WIRELESS_RX_QUEUE_SIZE          1      ///< Number of payloads we can queue
...
#define SYS_CFG_DESIRED_CPU_CLK	(96 * 1000 * 1000UL)    ///< Define the CPU speed you desire, must be between 1-100Mhz
#define SYS_CFG_DEFAULT_CPU_CLK (48 * 1000 * 1000UL)    ///< Do not change.  This is the fall-back CPU speed if SYS_CFG_DESIRED_CPU_CLK cannot be attained
